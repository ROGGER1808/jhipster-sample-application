...
import com.transon.InventoryManagementApp;
import com.transon.config.TestSecurityConfiguration;
import com.transon.config.audit.AuditEventConverter;
import com.transon.domain.PersistentAuditEvent;
import com.transon.repository.PersistenceAuditEventRepository;
import com.transon.security.AuthoritiesConstants;
import com.transon.service.AuditEventService;
...
@SpringBootTest(classes = { InventoryManagementApp.class, TestSecurityConfiguration.class })
@Transactional
